...
var $author$project$Route$Courses = function (a) {
	return {$: 'Courses', a: a};
};
var $author$project$Route$Home = {$: 'Home'};
var $author$project$Route$HomeCourses = {$: 'HomeCourses'};
...
var $author$project$Route$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$HomeCourses,
			A2(
...
var $author$project$Route$parseUrl = function (url) {
	var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Route$routes, url);
	if (_v0.$ === 'Just') {
		var route = _v0.a;
		return route;
	} else {
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		var initRoute = $author$project$Route$parseUrl(url);
		var _v1 = A2($elm$core$Debug$log, 'url', url);
		return _Utils_Tuple2(
			{route: initRoute},
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$UrlChange = {$: 'UrlChange'};
...
var $author$project$Main$routeContent = function (route) {
	switch (route.$) {
		case 'NotFound':
			return A2(
				$elm$html$Html$div,
		...
		case 'Top':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('This is the top page')
					]));
		case 'Home':
			return A2(
				$elm$html$Html$div,
		...
		case 'HomeCourses':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Home Courses')
					]));
		default:
			var name = route.a;
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Course detail ' + name)
					]));
	}
};
var $author$project$Main$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$Main$routeContent(model.route)
			]),
		title: 'Main title'
	};
};
